...
- Email notification to Health Monitoring leadership is sent with SMAWI description and link to SMAWI
- Health Monitoring Team will assigns SMAWI work item to themselves
- Health Monitoring Lead starts resolution process by following alert-specific playbook
- #**Playbook: SecMon - Configuration File Removed on Splunk Backend**
  ...
  - P2 - Medium Severity - SLA 8 Hour Response 
   - Medium Severity (1st Offense)
      ...
      - Lead may hand any explanations or retraining requested by Offender&#39;s Manager and/or HM team member
