 An alert from the Distributed Monitoring Console (DMC) is triggered due to an index that has had a decrease in volume of data over a specified threshold duration
